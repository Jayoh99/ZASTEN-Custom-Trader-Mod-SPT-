...
public record ModMetadata : AbstractModMetadata
{
    ...
    public override SemanticVersioning.Range SptVersion { get; init; } = new("~4.0.7");
    public override List<string>? Incompatibilities { get; init; }
    public override Dictionary<string, SemanticVersioning.Range>? ModDependencies { get; init; }
    public override string? Url { get; init; } = "https://github.com/Jayoh99/ZASTEN-Custom-Trader-Mod-SPT-";
    ...
    : IOnLoad
{
    ...
    public Task OnLoad()
    {
        ...
        addCustomTraderHelper.AddTraderToLocales(traderBase, "Zasten", "Mysterious black-market dealer");
